...
public class SaucerSeparation extends BaseShipSystemScript {
    ...
    private static final String REQUIRED_HULL_ID = "fed_galaxy";
    ...
    // Local offset vectors matching weapon slot alignments
    private static final Vector2f OFFSET_SAUCER = new Vector2f(135f, 1.5f);      // WS 022
    private static final Vector2f OFFSET_STARDRIVE = new Vector2f(-129.5f, 1.5f); // WS 021
